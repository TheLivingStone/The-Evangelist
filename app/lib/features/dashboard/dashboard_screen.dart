        ...
        child: CustomScrollView(
          slivers: [
            SliverAppBar(
              floating: true,
              title: profile.when(
                data: (p) => Text('Hi, ${p?.fullName.split(' ').first ?? ''} 👋'),
                loading: () => const Text('…'),
                error: (_, __) => const Text('The Evangelist'),
              ),
            ),
            SliverPadding(
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Weekly Mission',
                style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
            const SizedBox(height: 6),
            Text('Share the Gospel $goal days this week',
                style: TextStyle(
                    color: Theme.of(context)
                        .colorScheme
                        .onSurface
  ...
  Widget build(BuildContext context) {
    return Card(
      child: ListTile(
        ...
        title: const Text('Daily Encouragement',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            recent.when(
              data: (list) => list.isEmpty
                  ? Text('Nothing yet — tap ➕ to log your first outreach.',
                      style: TextStyle(
                          color: Theme.of(context)
                              .colorScheme
                              .onSurface
